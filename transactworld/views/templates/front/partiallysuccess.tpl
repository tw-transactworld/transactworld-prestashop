...
<p class="alert alert-success">{l s='Thank you for shopping with us. Your credit card has been partially charged and your transaction is partially successful. We will be shipping your order to you soon.' mod='transactworld'}</p>
<div id="mymodule_block_home" class="box cheque-box" >
	<p>
		{l s='Your order is partially successful.' sprintf=$shop_name mod='transactworld'}
